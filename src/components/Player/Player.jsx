...
const Player = () => {
  ...
  useEffect(() => {
    const handleTouchMove = (event) => {
      ...
      const isInsideScrollable = target.closest(".comments-list");
  ...
  const takeToUserUsingComments = (author) => {
    navigate(`/profile/${author}`);
  };
  ...
  const toggleCommentsModal = () => {
    if (commentsRef.current) {
      commentsRef.current.classList.add('del-com');
    }
