    ...
    return (
        <div className={`sidebar ${isOpen ? 'open' : 'closed'}`}>
            <ul className='act'>
                ...
                <Link to="/foryou" className={`sidebar-link ${loc.pathname == "/foryou" || loc.pathname == "/" ? "active" : ""}`}>
                ...
                <Link to="/profile" className={`sidebar-link profile-svg ${loc.pathname == "/profile" ? "active" : ""}`}>
